...
class MCPToolLoader:
    ...
    def __init__(self, server_configs: Optional[Dict] = None):
        """
...
def get_mcp_loader(server_configs: Optional[Dict] = None) -> MCPToolLoader:
    """
...
async def load_mcp_tools(server_configs: Optional[Dict] = None) -> List[BaseTool]:
    """
