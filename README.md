...
```
Good Taste
  └─ State graph eliminates complex conditionals; edge cases naturally integrated

Pragmatism
  └─ Solve real problems: safe code generation + human decision authority

Simplicity
  └─ Each agent does one thing, does it perfectly
```
...
1. Create tool module under `src/tools/`
...
**Design Principle**: Code is poetry, architecture is philosophy, simplification is the highest form of complexity.
